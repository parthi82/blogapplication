    ...
    <body>
        ...
        <div class="container">
            <div class="well">
		       ...
		       <p id ="alerttxt">
		        <% String val = (String)request.getAttribute("login");
							          if(val != null) 
                ...
                <form class="form-horizontal" id="loginform" method="post" action="/login">
                    ...
                    <div class="form-group" id="state2">
                        <label class="col-xs-2 control-label">Email or Userid</label>
                        <div class="col-xs-9 col-sm-9 col-md-9">
                            <input type="text" id="login" name="login" class="form-control input-lg" placeholder="Enter your email id" onblur="validatelogin();" value=<% String login = (String)request.getAttribute( "login"); if(login != null) out.print(login); %> >
